                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text"><i
                                ...
                                placeholder="Ketik judul foto..." value="{{ old('title') }}" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description"
                            ...
                            placeholder="Ketik deskripsi singkat mengenai foto...">{{ old('description') }}</textarea>
                        @error('description')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="form-group">
                        <label for="image" class="form-control-label">File Gambar</label>
                        <div class="custom-file"><input type="file" name="image"
                                class="custom-file-input @error('image') is-invalid @enderror" id="image" lang="id"
                                accept="image/*" required><label class="custom-file-label text-left" for="image">Pilih
                                gambar...</label></div>
                        <small class="form-text text-muted">Ukuran file maksimal 2MB. Format: JPG, PNG, GIF.</small>
    ...
    <div class="col-md-4">
        <div class="card shadow">
            ...
            <div class="card-body text-center p-4">
                <img src="{{ asset('assets/backend/img/image-default.png') }}" alt="preview" class="img-fluid rounded"
