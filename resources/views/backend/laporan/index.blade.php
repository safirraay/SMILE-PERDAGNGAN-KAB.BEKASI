                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="start_date" id="start_date" class="form-control datepicker"
                                    placeholder="Pilih tanggal awal" type="text" value="{{ date('Y-m-01') }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="end_date" id="end_date" class="form-control datepicker"
                                    placeholder="Pilih tanggal akhir" type="text" value="{{ date('Y-m-d') }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
...
<script>
    $(document).ready(function() {
        ...
        $('#export-pdf-btn').on('click', function() {
            ...
            var url = new URL('{{ route('laporan.exportPdf') }}');
